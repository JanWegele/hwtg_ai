...
public class A_Star {
	...
	// In cost und pred sind genau alle Knoten der closedList und openList
	// enthalten!
	// Nachdem der Zielknoten erreicht wurde, lässt sich aus cost und pred der
	// Ergebnispfad ermitteln.
