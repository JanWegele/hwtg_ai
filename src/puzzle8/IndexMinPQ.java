 ...
 * Beachte Unterschied zur Java PriorityList, wo Prioritätswerte nur mit O(n)
 * geändert werden können.
 * 
 * Operation add, change, remove, removeMin in O(log n).
 * Operation get, getMinKey, getMinValue in O(1) (Hashtabelle bzw. indizierter
 * Zugriff).
 * 
 * Siehe auch IndexMinPQ in Sedgewick, Algorthms, 4.ed., 2012, Seite 320.
 * 
 * @author Oliver Bittel
 * @param <Key>       Schlüsseltyp. Vorsicht: hashCode muss geeignet
 *                    überschrieben sein.
 * @param <PrioValue> Prioritätswerte. PrioValue muss vom Subtpy
 *                    Comparable<PrioValue> sein (Prüfung zur Laufzeit).
 * @since 21.3.2021
 */
public class IndexMinPQ<Key, PrioValue> {
	 ...
	 * @return alter Prioritätswert oder null, falls Schlüssel k nicht vorhanden
	 *         ist.
	 */
	...
	public PrioValue remove(Key k) {
		...
		heap[size - 1] = null;
		size--;
		// System.out.println("prioPos.get(heap[remPos]) = " +
		// prioPos.get(heap[remPos]));
	 ...
	 * 
	 * @return Schlüssel mit kleinstem Prioritätswert oder null, falls
	 *         Prioritätsliste leer ist.
	 */
	...
	private void downheap(int i) {
		...
		// Im unteren Teil des Heap-Pfades einfuegen (analog zu Sortien durch
		// Einfuegen):
	...
	public static void main(String[] args) {
		...
		// "xyz": 1 // Reihenfolge von "xyz" und "uvw" ist nicht eindeutig, da beide
		// PrioWerte = 1.
		// "uvw": 1
		// "jkl": 2
		// "def": 3
